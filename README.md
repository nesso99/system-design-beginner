...
- [Khởi động](#kh%E1%BB%9Fi-%C4%91%E1%BB%99ng)
  ...
  - [Bước tiếp theo](#b%C6%B0%E1%BB%9Bc-ti%E1%BA%BFp-theo)
- [Hiệu năng và Khả năng mở rộng](#hi%E1%BB%87u-n%C4%83ng-v%C3%A0-kh%E1%BA%A3-n%C4%83ng-m%E1%BB%9F-r%E1%BB%99ng)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm)
- [Độ trễ và Thông lượng](#%C4%91%E1%BB%99-tr%E1%BB%85-v%C3%A0-th%C3%B4ng-l%C6%B0%E1%BB%A3ng)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-1)
...
- [Các mẫu nhất quán (Consistency patterns)](#c%C3%A1c-m%E1%BA%ABu-nh%E1%BA%A5t-qu%C3%A1n-consistency-patterns)
  ...
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-2)
- [Availability patterns](#availability-patterns)
  - [Failover](#failover)
    - [Active-passive](#active-passive)
    - [Active-active](#active-active)
  - [Nhược điểm: failover](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-failover)
  - [Nhân bản](#nh%C3%A2n-b%E1%BA%A3n)
    - [Master-slave and master-master](#master-slave-and-master-master)
- [Domain name system](#domain-name-system)
  - [Nhược điểm: DNS](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-dns)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-3)
- [Content delivery network (CDN)](#content-delivery-network-cdn)
  - [Push CDN](#push-cdn)
  - [Pull CDN](#pull-cdn)
  - [Một số tài nguyên CDN miễn phí](#m%E1%BB%99t-s%E1%BB%91-t%C3%A0i-nguy%C3%AAn-cdn-mi%E1%BB%85n-ph%C3%AD)
  - [Nhược điểm: CDN](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-cdn)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-4)
- [Bộ cân bằng tải (Load Balancer)](#b%E1%BB%99-c%C3%A2n-b%E1%BA%B1ng-t%E1%BA%A3i-load-balancer)
  ...
  - [Mở rộng theo chiều ngang (Horizontal scaling)](#m%E1%BB%9F-r%E1%BB%99ng-theo-chi%E1%BB%81u-ngang-horizontal-scaling)
    - [Nhược điểm: horizontal scaling](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-horizontal-scaling)
  - [Nhược điểm: load balancer](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-load-balancer)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-5)
- [Reverse proxy (web server)](#reverse-proxy-web-server)
  - [Load balancer vs reverse proxy](#load-balancer-vs-reverse-proxy)
  - [Nhược điểm: reverse proxy](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-reverse-proxy)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-6)
- [Application layer](#application-layer)
  - [Microservices](#microservices)
  - [Service Discovery](#service-discovery)
  - [Nhược điểm: application layer](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-application-layer)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-7)
- [Cơ sở dữ liệu (Database)](#c%C6%A1-s%E1%BB%9F-d%E1%BB%AF-li%E1%BB%87u-database)
  - [Relational database management system (RDBMS)](#relational-database-management-system-rdbms)
    - [Master-slave replication](#master-slave-replication)
      - [Nhược điểm: master-slave replication](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-master-slave-replication)
    - [Master-master replication](#master-master-replication)
      - [Nhược điểm: master-master replication](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-master-master-replication)
      - [Nhược điểm: replication](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-replication)
      - [Nguồn và tài liệu đọc thêm: replication](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-replication)
    - [Federation](#federation)
      - [Nhược điểm: federation](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-federation)
      - [Nguồn và tài liệu đọc thêm: federation](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-federation)
    - [Sharding](#sharding)
      - [Nhược điểm: sharding](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-sharding)
      - [Nguồn và tài liệu đọc thêm: sharding](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-sharding)
    - [Denormalization](#denormalization)
      - [Nhược điểm: denormalization](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-denormalization)
        - [Nguồn và tài liệu đọc thêm: denormalization](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-denormalization)
    - [SQL tuning](#sql-tuning)
      - [Làm chặt hơn schema](#l%C3%A0m-ch%E1%BA%B7t-h%C6%A1n-schema)
      - [Sử dụng việc đánh chỉ số tốt](#s%E1%BB%AD-d%E1%BB%A5ng-vi%E1%BB%87c-%C4%91%C3%A1nh-ch%E1%BB%89-s%E1%BB%91-t%E1%BB%91t)
      - [Tránh join](#tr%C3%A1nh-join)
      - [Phân mảnh bảng](#ph%C3%A2n-m%E1%BA%A3nh-b%E1%BA%A3ng)
      - [Điều chỉnh query cache](#%C4%91i%E1%BB%81u-ch%E1%BB%89nh-query-cache)
      - [Nguồn và tài liệu đọc thêm: SQL tuning](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-sql-tuning)
  - [Cơ sở dữ liệu NoSQL](#c%C6%A1-s%E1%BB%9F-d%E1%BB%AF-li%E1%BB%87u-nosql)
    - [Key-value store](#key-value-store)
      - [Nguồn và tài liệu đọc thêm: key-value store](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-key-value-store)
    - [Document store](#document-store)
      - [Nguồn và tài liệu đọc thêm: document store](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-document-store)
    - [Wide column store](#wide-column-store)
      - [Nguồn và tài liệu đọc thêm: wide column store](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-wide-column-store)
    - [Graph database](#graph-database)
      - [Nguồn và tài liệu đọc thêm: graph](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-graph)
    - [Nguồn và tài liệu đọc thêm: NoSQL](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-nosql)
  - [SQL hay NoSQL](#sql-hay-nosql)
      - [Nguồn và tài liệu đọc thêm: SQL or NoSQL](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-sql-or-nosql)
- [Cache](#cache)
  ...
  - [Khi nào nên cập nhật cache](#khi-n%C3%A0o-n%C3%AAn-c%E1%BA%ADp-nh%E1%BA%ADt-cache)
    ...
    - [Write-behind (write-back)](#write-behind-write-back)
      - [Nhược điểm: write-behind](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-write-behind)
    - [Refresh-ahead](#refresh-ahead)
      - [Bất lợi: refresh-ahead](#b%E1%BA%A5t-l%E1%BB%A3i-refresh-ahead)
  - [Nhược điểm: cache](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-cache)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-8)
- [Bất đồng bộ (Asynchronism)](#b%E1%BA%A5t-%C4%91%E1%BB%93ng-b%E1%BB%99-asynchronism)
  - [Message queues](#message-queues)
  - [Task queues](#task-queues)
  - [Back pressure](#back-pressure)
  - [Nhược điểm: asynchronism](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-asynchronism)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-9)
- [Communication](#communication)
  - [Hypertext transfer protocol (HTTP)](#hypertext-transfer-protocol-http)
  - [Transmission control protocol (TCP)](#transmission-control-protocol-tcp)
  - [User datagram protocol (UDP)](#user-datagram-protocol-udp)
  - [Remote procedure call (RPC)](#remote-procedure-call-rpc)
    - [Nhược điểm: RPC](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-rpc)
  - [Representational state transfer (REST)](#representational-state-transfer-rest)
    - [Nhược điểm: REST](#nh%C6%B0%E1%BB%A3c-%C4%91i%E1%BB%83m-rest)
  - [So sánh RPC and REST](#so-s%C3%A1nh-rpc-and-rest)
    - [Nguồn và tài liệu đọc thêm: REST and RPC](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-rest-and-rpc)
- [Bảo mật (Security)](#b%E1%BA%A3o-m%E1%BA%ADt-security)
  - [Nguồn và tài liệu đọc thêm](#ngu%E1%BB%93n-v%C3%A0-t%C3%A0i-li%E1%BB%87u-%C4%91%E1%BB%8Dc-th%C3%AAm-10)
  - [Sử dụng JWT cho việc định danh (authentication)](#s%E1%BB%AD-d%E1%BB%A5ng-jwt-cho-vi%E1%BB%87c-%C4%91%E1%BB%8Bnh-danh-authentication)
- [TODO](#todo)
