...
Bạn sẽ thỉnh thoảng được yêu cầu đưa ra các ước tính nhanh chóng. Ví dụ, bạn có thể cần xác định mất bao lâu để tạo ra 100 ảnh thumbnails từ đĩa cứng hoặc bao nhiêu dung lượng mà một cấu trúc dữ liệu sẽ chiếm. **Bảng lũy thừa của 2** và **Các con số độ trễ mà các lập trình viên nên biết** là các tài liệu tham khảo tiện lợi.
...
### Các con số độ trễ mà các lập trình viên nên biết
